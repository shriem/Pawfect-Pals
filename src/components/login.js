  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-orange-100">
      <div className="text-center mb-8">
        ...
        <h2 className="text-orange-500 text-2xl font-semibold">Welcome back to Pawfect Pals</h2>
      </div>
      <form className="bg-orange-200 p-6 rounded-lg shadow-md w-60%">
        ...
        <button className="bg-orange-500 text-white py-2 px-4 rounded-full transition duration-300 hover:bg-orange-600 focus:outline-none focus:shadow-outline" type="submit">
          Log In
        </button>
      </form>
    </div>
